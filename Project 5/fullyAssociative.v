...
assign line_0_valid = ~ read_address[0];
assign line_1_valid =   read_address[0];

assign line_0_match_1 = read_address[1] ~^ line_0_tag[1];
assign line_0_match_0 = read_address[0] ~^ line_0_tag[0];
assign read_hit = line_0_match_1 & line_0_match_0;
assign line_0_valid_match = line_0_valid & read_hit;

assign line_1_match_1 = read_address[1] ~^ line_1_tag[1];
assign line_1_match_0 = read_address[0] ~^ line_1_tag[0];
assign read_hit = line_1_match_1 & line_1_match_0;
assign line_1_valid_match = line_1_valid & read_hit;

assign read_hit = line_0_valid_match | line_1_valid_match;

assign line_0_block_07_match = read_hit & line_0_block[7];
assign line_0_block_06_match = read_hit & line_0_block[6];
assign line_0_block_05_match = read_hit & line_0_block[5];
assign line_0_block_04_match = read_hit & line_0_block[4];
assign line_0_block_03_match = read_hit & line_0_block[3];
assign line_0_block_02_match = read_hit & line_0_block[2];
assign line_0_block_01_match = read_hit & line_0_block[1];
assign line_0_block_00_match = read_hit & line_0_block[0];

assign line_1_block_07_match = read_hit & line_1_block[7];
assign line_1_block_06_match = read_hit & line_1_block[6];
assign line_1_block_05_match = read_hit & line_1_block[5];
assign line_1_block_04_match = read_hit & line_1_block[4];
assign line_1_block_03_match = read_hit & line_1_block[3];
assign line_1_block_02_match = read_hit & line_1_block[2];
assign line_1_block_01_match = read_hit & line_1_block[1];
assign line_1_block_00_match = read_hit & line_1_block[0];
